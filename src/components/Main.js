    ...
    return (
        <main className={`main--container ${props.darkMode ? "dark" : ""}`}>
            ...
            <div>
                ...
                <p className="main--text">Currently seeking employment in Front End Web Development for a company that has strong values as well as an emphasise on continued learning, skill, and professional progression. If you want to connect or know more about me, reach out via any of the following links.</p>
            </div>
